...
class CustomerControllerTest {
    ...
    public void testDeleteCustomer() throws Exception {
        ...
        mockMvc.perform(delete(CUSTOMER_PATH_ID, id).with(httpBasic(user, password)))
                .andExpect(status().isNoContent());
    ...
    public void testListCustomers() throws Exception {
        ...
        mockMvc.perform(get(CUSTOMER_PATH).with(httpBasic(user, password)).accept(MediaType.APPLICATION_JSON))
    ...
    public void testGetCustomerById() throws Exception {
        ...
        mockMvc.perform(get(CUSTOMER_PATH_ID, customer.getId()).with(httpBasic(user, password)).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
